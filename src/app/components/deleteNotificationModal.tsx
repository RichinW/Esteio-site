...
const DeleteNotificationModal: FC<DeleteModal> = ({ name, returnEvent, list, apiRoute, baseRoute }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <div className="absolute h-screen top-0 left-0 w-screen bg-black bg-opacity-50 flex justify-center items-center">
            ...
            <div className="w-full flex flex-col justify-center gap-6 items-center h-full">
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <p className="text-center px-5 text-gray-400">
                  Tem certeza que deseja deletar essa produção? Você não poderá
                  mais ve-la novamente.
                </p>
              </div>
